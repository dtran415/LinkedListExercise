...
describe("removeAt", function() {
  ...
  it("removes first item properly", function() {
  ...
  it("removes last item properly", function() {
    let lst = new LinkedList(["a", "b", "c"]);
  ...
  it("removes from middle properly", function() {
    let lst = new LinkedList(["a", "b", "c"]);
  ...
  it("throws error if invalid index", function() {
    const test = () => {
      let lst = new LinkedList(["a", "b", "c"]);
